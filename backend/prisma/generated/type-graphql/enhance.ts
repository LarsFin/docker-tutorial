...
const modelsInfo = {
  Genre: ["id", "slug", "imgSrc"],
  Platform: ["id", "slug", "imgSrc"],
  Game: ["id", "slug", "imgSrc", "publisherId"],
  Publisher: ["id", "slug", "imgSrc"]
};
...
const outputsInfo = {
  ...
  GenreGroupBy: ["id", "slug", "imgSrc", "_count", "_avg", "_sum", "_min", "_max"],
  AggregatePlatform: ["_count", "_avg", "_sum", "_min", "_max"],
  PlatformGroupBy: ["id", "slug", "imgSrc", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateGame: ["_count", "_avg", "_sum", "_min", "_max"],
  GameGroupBy: ["id", "slug", "imgSrc", "publisherId", "_count", "_avg", "_sum", "_min", "_max"],
  AggregatePublisher: ["_count", "_avg", "_sum", "_min", "_max"],
  PublisherGroupBy: ["id", "slug", "imgSrc", "_count", "_avg", "_sum", "_min", "_max"],
  AffectedRowsOutput: ["count"],
  GenreCount: ["games"],
  GenreCountAggregate: ["id", "slug", "imgSrc", "_all"],
  GenreAvgAggregate: ["id"],
  GenreSumAggregate: ["id"],
  GenreMinAggregate: ["id", "slug", "imgSrc"],
  GenreMaxAggregate: ["id", "slug", "imgSrc"],
  PlatformCount: ["games"],
  PlatformCountAggregate: ["id", "slug", "imgSrc", "_all"],
  PlatformAvgAggregate: ["id"],
  PlatformSumAggregate: ["id"],
  PlatformMinAggregate: ["id", "slug", "imgSrc"],
  PlatformMaxAggregate: ["id", "slug", "imgSrc"],
  GameCount: ["genres", "platforms"],
  GameCountAggregate: ["id", "slug", "imgSrc", "publisherId", "_all"],
  GameAvgAggregate: ["id", "publisherId"],
  GameSumAggregate: ["id", "publisherId"],
  GameMinAggregate: ["id", "slug", "imgSrc", "publisherId"],
  GameMaxAggregate: ["id", "slug", "imgSrc", "publisherId"],
  PublisherCount: ["games"],
  PublisherCountAggregate: ["id", "slug", "imgSrc", "_all"],
  PublisherAvgAggregate: ["id"],
  PublisherSumAggregate: ["id"],
  PublisherMinAggregate: ["id", "slug", "imgSrc"],
  PublisherMaxAggregate: ["id", "slug", "imgSrc"]
};
...
const inputsInfo = {
  GenreWhereInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc", "games"],
  GenreOrderByWithRelationInput: ["id", "slug", "imgSrc", "games"],
  GenreWhereUniqueInput: ["id"],
  GenreOrderByWithAggregationInput: ["id", "slug", "imgSrc", "_count", "_avg", "_max", "_min", "_sum"],
  GenreScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc"],
  PlatformWhereInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc", "games"],
  PlatformOrderByWithRelationInput: ["id", "slug", "imgSrc", "games"],
  PlatformWhereUniqueInput: ["id"],
  PlatformOrderByWithAggregationInput: ["id", "slug", "imgSrc", "_count", "_avg", "_max", "_min", "_sum"],
  PlatformScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc"],
  GameWhereInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc", "publisher", "publisherId", "genres", "platforms"],
  GameOrderByWithRelationInput: ["id", "slug", "imgSrc", "publisher", "publisherId", "genres", "platforms"],
  GameWhereUniqueInput: ["id"],
  GameOrderByWithAggregationInput: ["id", "slug", "imgSrc", "publisherId", "_count", "_avg", "_max", "_min", "_sum"],
  GameScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc", "publisherId"],
  PublisherWhereInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc", "games"],
  PublisherOrderByWithRelationInput: ["id", "slug", "imgSrc", "games"],
  PublisherWhereUniqueInput: ["id"],
  PublisherOrderByWithAggregationInput: ["id", "slug", "imgSrc", "_count", "_avg", "_max", "_min", "_sum"],
  PublisherScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc"],
  GenreCreateInput: ["slug", "imgSrc", "games"],
  GenreUpdateInput: ["slug", "imgSrc", "games"],
  GenreCreateManyInput: ["id", "slug", "imgSrc"],
  GenreUpdateManyMutationInput: ["slug", "imgSrc"],
  PlatformCreateInput: ["slug", "imgSrc", "games"],
  PlatformUpdateInput: ["slug", "imgSrc", "games"],
  PlatformCreateManyInput: ["id", "slug", "imgSrc"],
  PlatformUpdateManyMutationInput: ["slug", "imgSrc"],
  GameCreateInput: ["slug", "imgSrc", "publisher", "genres", "platforms"],
  GameUpdateInput: ["slug", "imgSrc", "publisher", "genres", "platforms"],
  GameCreateManyInput: ["id", "slug", "imgSrc", "publisherId"],
  GameUpdateManyMutationInput: ["slug", "imgSrc"],
  PublisherCreateInput: ["slug", "imgSrc", "games"],
  PublisherUpdateInput: ["slug", "imgSrc", "games"],
  PublisherCreateManyInput: ["id", "slug", "imgSrc"],
  PublisherUpdateManyMutationInput: ["slug", "imgSrc"],
  IntFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not"],
  StringFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "mode", "not"],
  GameListRelationFilter: ["every", "some", "none"],
  GameOrderByRelationAggregateInput: ["_count"],
  GenreCountOrderByAggregateInput: ["id", "slug", "imgSrc"],
  GenreAvgOrderByAggregateInput: ["id"],
  GenreMaxOrderByAggregateInput: ["id", "slug", "imgSrc"],
  GenreMinOrderByAggregateInput: ["id", "slug", "imgSrc"],
  GenreSumOrderByAggregateInput: ["id"],
  IntWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
  StringWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "contains", "startsWith", "endsWith", "mode", "not", "_count", "_min", "_max"],
  PlatformCountOrderByAggregateInput: ["id", "slug", "imgSrc"],
  PlatformAvgOrderByAggregateInput: ["id"],
  PlatformMaxOrderByAggregateInput: ["id", "slug", "imgSrc"],
  PlatformMinOrderByAggregateInput: ["id", "slug", "imgSrc"],
  ...
  GameCountOrderByAggregateInput: ["id", "slug", "imgSrc", "publisherId"],
  GameAvgOrderByAggregateInput: ["id", "publisherId"],
  GameMaxOrderByAggregateInput: ["id", "slug", "imgSrc", "publisherId"],
  GameMinOrderByAggregateInput: ["id", "slug", "imgSrc", "publisherId"],
  GameSumOrderByAggregateInput: ["id", "publisherId"],
  IntNullableWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_avg", "_sum", "_min", "_max"],
  PublisherCountOrderByAggregateInput: ["id", "slug", "imgSrc"],
  PublisherAvgOrderByAggregateInput: ["id"],
  PublisherMaxOrderByAggregateInput: ["id", "slug", "imgSrc"],
  PublisherMinOrderByAggregateInput: ["id", "slug", "imgSrc"],
  ...
  GameCreateWithoutGenresInput: ["slug", "imgSrc", "publisher", "platforms"],
  ...
  GameScalarWhereInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc", "publisherId"],
  GameCreateWithoutPlatformsInput: ["slug", "imgSrc", "publisher", "genres"],
  ...
  GenreScalarWhereInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc"],
  ...
  PlatformScalarWhereInput: ["AND", "OR", "NOT", "id", "slug", "imgSrc"],
  GameCreateWithoutPublisherInput: ["slug", "imgSrc", "genres", "platforms"],
  ...
  GameUpdateWithoutGenresInput: ["slug", "imgSrc", "publisher", "platforms"],
  GameUpdateWithoutPlatformsInput: ["slug", "imgSrc", "publisher", "genres"],
  GenreUpdateWithoutGamesInput: ["slug", "imgSrc"],
  PlatformUpdateWithoutGamesInput: ["slug", "imgSrc"],
  GameCreateManyPublisherInput: ["id", "slug", "imgSrc"],
  GameUpdateWithoutPublisherInput: ["slug", "imgSrc", "genres", "platforms"]
};
