...
const inputsInfo = {
  ...
  GameWhereInput: ["AND", "OR", "NOT", "id", "slug", "publisher", "publisherId", "genres"],
  GameOrderByWithRelationInput: ["id", "slug", "publisher", "publisherId", "genres"],
  ...
  GameCreateInput: ["slug", "publisher", "genres"],
  GameUpdateInput: ["slug", "publisher", "genres"],
  ...
  GameCreateWithoutGenresInput: ["slug", "publisher"],
  ...
  GameCreateWithoutPublisherInput: ["slug", "genres"],
  ...
  GameUpdateWithoutGenresInput: ["slug", "publisher"],
  GenreUpdateWithoutGamesInput: ["slug"],
  GameCreateManyPublisherInput: ["id", "slug"],
  GameUpdateWithoutPublisherInput: ["slug", "genres"]
};
