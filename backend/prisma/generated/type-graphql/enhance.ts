...
const modelsInfo = {
  Genre: ["id", "slug"],
  Platform: ["id", "slug"],
  Game: ["id", "slug", "coverUrl", "publisherId"],
  Publisher: ["id", "slug"]
};
...
const outputsInfo = {
  ...
  GameGroupBy: ["id", "slug", "coverUrl", "publisherId", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  GameCountAggregate: ["id", "slug", "coverUrl", "publisherId", "_all"],
  GameAvgAggregate: ["id", "publisherId"],
  GameSumAggregate: ["id", "publisherId"],
  GameMinAggregate: ["id", "slug", "coverUrl", "publisherId"],
  GameMaxAggregate: ["id", "slug", "coverUrl", "publisherId"],
...
const inputsInfo = {
  ...
  GameWhereInput: ["AND", "OR", "NOT", "id", "slug", "coverUrl", "publisher", "publisherId", "genres", "platforms"],
  GameOrderByWithRelationInput: ["id", "slug", "coverUrl", "publisher", "publisherId", "genres", "platforms"],
  GameWhereUniqueInput: ["id"],
  GameOrderByWithAggregationInput: ["id", "slug", "coverUrl", "publisherId", "_count", "_avg", "_max", "_min", "_sum"],
  GameScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "slug", "coverUrl", "publisherId"],
  ...
  GameCreateInput: ["slug", "coverUrl", "publisher", "genres", "platforms"],
  GameUpdateInput: ["slug", "coverUrl", "publisher", "genres", "platforms"],
  GameCreateManyInput: ["id", "slug", "coverUrl", "publisherId"],
  GameUpdateManyMutationInput: ["slug", "coverUrl"],
  ...
  GameCountOrderByAggregateInput: ["id", "slug", "coverUrl", "publisherId"],
  GameAvgOrderByAggregateInput: ["id", "publisherId"],
  GameMaxOrderByAggregateInput: ["id", "slug", "coverUrl", "publisherId"],
  GameMinOrderByAggregateInput: ["id", "slug", "coverUrl", "publisherId"],
  ...
  GameCreateWithoutGenresInput: ["slug", "coverUrl", "publisher", "platforms"],
  ...
  GameScalarWhereInput: ["AND", "OR", "NOT", "id", "slug", "coverUrl", "publisherId"],
  GameCreateWithoutPlatformsInput: ["slug", "coverUrl", "publisher", "genres"],
  ...
  GameCreateWithoutPublisherInput: ["slug", "coverUrl", "genres", "platforms"],
  ...
  GameUpdateWithoutGenresInput: ["slug", "coverUrl", "publisher", "platforms"],
  GameUpdateWithoutPlatformsInput: ["slug", "coverUrl", "publisher", "genres"],
  GenreUpdateWithoutGamesInput: ["slug"],
  PlatformUpdateWithoutGamesInput: ["slug"],
  GameCreateManyPublisherInput: ["id", "slug", "coverUrl"],
  GameUpdateWithoutPublisherInput: ["slug", "coverUrl", "genres", "platforms"]
};
